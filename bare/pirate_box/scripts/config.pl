...
# System config
use constant ADMIN_PASS => '{ADMIN_PASSWORD}';	# Admin password. For fucks's sake, change this.
use constant SECRET => '{SECRET}';		# Cryptographic secret. CHANGE THIS to something totally random, and long.
